...
\subsection{Effizientes Ziehen von $G(n, p)$ Graphen}
...
\begin{itemize}
    ...
    \item Einige Generator können anhand eines fixierten Startzustands (Random-Seed) diesselben Graphen wiederholt erzeugen.
...
\begin{itemize}
    ...
    \item Binomial, Geometrisch, Hypergeometrisch, Poisson
\end{itemize}
...
\end{exercise}
\begin{exercise}
    Zeige wie wir eine uniforme Verteilung $[0, 1]$ in eine geometrische Verteilung umformen können.
\end{exercise}
\begin{exercise}
